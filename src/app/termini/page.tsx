    ...
    <div className="bg-background py-16 sm:py-20">
      <div className="container mx-auto max-w-4xl px-4 md:px-6">
        <div className="prose prose-lg mx-auto text-foreground/90 prose-headings:font-headline prose-headings:text-primary prose-p:font-body prose-p:leading-relaxed">
          ...
          <p>
            Tuttavia, se dovessi riscontrare un problema con il tuo ordine o se la qualità del prodotto non dovesse rispettare i nostri elevati standard al momento della ricezione, ti preghiamo di contattarci immediatamente entro 24 ore dalla ricezione. Puoi scriverci a{' '}
            <a href="mailto:assistenza@fanulicarniequine.it">assistenza@fanulicarniequine.it</a>{' '}
            fornendo i dettagli del problema e, se possibile, una foto del prodotto.
          </p>
          <p>
